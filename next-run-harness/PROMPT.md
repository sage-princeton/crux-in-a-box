...
2. **Write the resource budget and initial plan in `PLAN.md`** (`AGENTS.md` § Your budget): allocate time, API spend, and GPU spend across the phases of work; name 2–3 candidate approaches; set milestone dates.
