...
Send `PROMPT.md` as the first message. Expect within ~6h: a corrected `TOOLS.md`, a milestone schedule and candidate portfolio logged as the first Tier-2 memo, a first commit, and the first snapshot at the next scheduled time.
