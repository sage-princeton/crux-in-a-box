...
//
// REQUIRE_EXTERNAL_REVIEWS is deliberately absent in this smoke-test variant:
// the run provisions no external reviewers (playbooks/review.md §2b), and
// gate_artifact.sh now FAILS if that flag is set, so including it here would
// make every ship attempt unpassable.
const SHIP_FLAGS = {
